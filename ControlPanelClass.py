...
class ControlPanel_main:
    ...
    def PulseWidthModulationBar(self, event):
    ...
    def Arrowbuttontext(self, event, screen):
    ...
    def Arrowbutton(self, event, screen):
    ...
    def ControlPanel(self, event, previousRes):
            screen.fill((0,0,0))
            ...
            self.Arrowbutton(event, screen)
            fin = self.Arrowbutton(event, screen) 
            self.Arrowbuttontext(event, screen)
            #if fin == False:
                #quit()
            newImage, newRes = self.PulseWidthModulationBar(event)
            #print(newRes)
